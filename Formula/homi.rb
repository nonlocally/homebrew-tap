class Homi < Formula
  ...
  url "https://github.com/nonlocally/HOMI/releases/download/v0.5.0/homi-0.5.0.tar.gz"
  sha256 "17882dfb57404fd9064ba098eb8e49a1c4b72885c9c9f58b43ed2235c002008b"
  license "MIT"
  ...
  test do
    ...
    assert_match "0.5.0", shell_output("#{bin}/homi version")
